...
const gameStats = await client.boxscore.getGameStats({ gameCode: 1, season: 2025 });
const roster = await client.boxscore.getGameRoster({ clubCode: "MAD", gameCode: 1, season: 2023 });

console.log(quarters);
console.log(players.slice(0, 5));
console.log(gameStats.local.total);
console.log(roster);
